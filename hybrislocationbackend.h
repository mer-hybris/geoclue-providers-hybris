...
enum {
    HYBRIS_GNSS_CAPABILITY_SCHEDULING = 1u,
    HYBRIS_GNSS_CAPABILITY_MSB = 2u,
    HYBRIS_GNSS_CAPABILITY_MSA = 4u,
    HYBRIS_GNSS_CAPABILITY_SINGLE_SHOT = 8u,
    HYBRIS_GNSS_CAPABILITY_ON_DEMAND_TIME = 16u,
    HYBRIS_GNSS_CAPABILITY_GEOFENCING = 32u,
    HYBRIS_GNSS_CAPABILITY_MEASUREMENTS = 64u,
    HYBRIS_GNSS_CAPABILITY_NAV_MESSAGES = 128u,
};
